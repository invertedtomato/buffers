...
namespace InvertedTomato.IO.Bits.Tests {
    ...
    public class BitsTests {
        ...
        public void ToString_Max() {
            Assert.AreEqual("11111111 11111111 11111111 11111111 11111111 11111111 11111111 11111111", BitOperation.ToString(ulong.MaxValue));
        }
        ...
        public void Push_0_1_1() {
            Assert.AreEqual((ulong)1,BitOperation.Push(0, 1, 1));
        }
        [TestMethod]
        public void Push_1_1_1() {
            Assert.AreEqual((ulong)3, BitOperation.Push(1, 1, 1));
        }
        [TestMethod]
        public void Push_1_3_1() {
            Assert.AreEqual((ulong)3, BitOperation.Push(1, 3, 1));
        }
        [TestMethod]
        public void Push_1_3_2() {
            Assert.AreEqual((ulong)7, BitOperation.Push(1, 3, 2));
        }

        [TestMethod]
        public void Pop_0_1() {
            Assert.AreEqual((ulong)0, BitOperation.Pop(0, 1));
        }
        [TestMethod]
        public void Pop_3_1() {
            Assert.AreEqual((ulong)1, BitOperation.Pop(3, 1));
        }
